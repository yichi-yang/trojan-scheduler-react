  ...
  return (
    <Segment padded="very" className="dynamic larger-text">
      ...
      <p>
        ...
        in the summer of 2019 because I was extremely frustrated by the USC Web
        Registration System, which does not have any builtin feature that helps
        students fix schedule conflicts.{" "}
      ...
      <p>
        ...
        but since it was a class project, it had to meet some requirements that
        honestly didn't make sense to me, and the app itself was hacked together
        in a short amount of time (you know how typical class project works).
        Given the less than ideal usability and lack of polish, I didn't think
        it was worth it to host it on a server.
      </p>
      <p>
        In the last few months, I started from scratch and coded a completely
        new web app (the one you see now) with Django and React.js. Part of the
        goal was to make the project more polished and maintainable, and to
        implements additional features that I wanted the app to have. On the
        other hand, I just wanted to play with popular backend and frontend
        frameworks and see what I can come up with. I indeed had lots of fun
      ...
      <p>
        ...
        (bug reports, feature requests, and anything related to the app itself)
      </p>
      <p>
